...
const DAY_DO = {
  ...
  2: ["Reach out", "Listen well", "Open up", "Be honest", "Call a friend", "Show you care"],
  ...
  6: ["Call someone close", "Enjoy the moment", "Be generous", "Spend time together", "Appreciate someone", "Make peace"],
  7: ["Trust your gut", "Take the meeting", "Stay calm", "Reflect quietly", "Follow instinct", "Wait and watch"],
...
const DAY_AVOID = {
  1: ["Ego trips", "Forcing others", "Overconfidence", "Going it alone", "Ignoring advice", "Being pushy"],
  2: ["Money from emotion", "Taking it personally", "Overthinking feelings", "Isolating yourself", "Mood swings", "Snap reactions"],
  3: ["Cutting corners", "Rushing decisions", "Ignoring your gut", "Lecturing others", "Over-promising", "Acting hastily"],
  4: ["Big purchases", "Quick commitments", "Trusting blindly", "Signing anything", "Easy-looking deals", "Acting on rumors"],
  5: ["Overthinking", "Greedy moves", "Skipping details", "Rushing money", "Risky bets", "Sloppy messages"],
  6: ["Overspending", "Harsh words", "Overindulging", "Forcing closeness", "Emotional buys", "Holding grudges"],
  7: ["Forcing outcomes", "Over-analyzing", "Chasing too hard", "Ignoring instinct", "Impulsive changes", "Forcing answers"],
  8: ["Shortcuts", "Impatience", "Giving up early", "Overloading", "Breaking routine", "Skipping the basics"],
  9: ["Picking fights", "Rash decisions", "Reckless speed", "Acting on anger", "Rushing physically", "Risky moves"],
};
