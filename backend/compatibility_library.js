...
// Same planet names as PLANET_NAMES_COMPAT above, kept as a separate export
// since call sites throughout this file already reference it by this name.
export const NEUTRAL_LABELS_COMPAT = PLANET_NAMES_COMPAT;
...
export const PAIR_DYNAMICS = {
  ...
  '1_3': { // Sun friends Jupiter, Jupiter friends Sun
    rel: 'f_f',
    core: "Sun and Jupiter — two of the most naturally aligned energies. Authority meets wisdom. What 1 initiates, 3 gives depth to. What 3 knows, 1 has the nerve to act on. Together they build things that last.",
  ...
  '1_7': { // Sun enemy Ketu, Ketu enemy Sun
    rel: 'e_e',
    core: "Sun and Ketu — the two most contrary energies in the system. One demands presence, authority, and visibility. The other withdraws, seeks the invisible, and is comfortable disappearing. Neither understands what the other is doing or why.",
  ...
  '2_8': { // Moon enemy Saturn, Saturn enemy Moon
    rel: 'e_e',
    core: "Moon and Saturn — two of the deepest givers in the system, running in direct opposition. Both invest enormous emotional and practical energy in the people they love. The problem is that neither asks for what they need — and what they need is very different.",
  ...
  '3_5': { // Jupiter enemy Mercury, Mercury enemy Jupiter
    rel: 'e_e',
    core: "Jupiter and Mercury — wisdom and intelligence in direct opposition. 3 operates from values, ethics, and long-term principles. 5 operates from analysis, efficiency, and what works now. Both are thinking — with fundamentally different starting points.",
  ...
  '3_6': { // Jupiter enemy Venus, Venus enemy Jupiter
    rel: 'e_e',
    core: "Jupiter and Venus — wisdom and beauty in creative tension. 3 values depth, ethics, and substance. 6 values beauty, harmony, and aesthetic richness. Neither considers the other's primary value frivolous — but neither naturally prioritizes it either.",
  ...
  '5_9': { // Mercury enemy Mars, Mars enemy Mercury
    rel: 'e_e',
    core: "Mercury and Mars — intelligence and energy in creative tension. 5 thinks, calculates, and plans. 9 charges, acts, and corrects course in motion. Neither naturally respects the other's process — but together they cover the full spectrum from analysis to execution.",
  ...
  '1_2': { // Sun enemy Moon, Moon friends Sun
    rel: 'e_f',
    core: "Sun and Moon — the most fundamental polarity in this system. 1 pulls toward authority, action, and external impact. 2 pulls toward depth, feeling, and internal attunement. The emotional side is drawn to the confident side's light. The confident side doesn't always notice the pull.",
  ...
  '3_8': { // Jupiter neutral Saturn, Saturn neutral Jupiter — both neutral
    rel: 'n_n',
    core: "Jupiter and Saturn — wisdom and patience. Both understand that what matters takes time. Both have high standards. Both give more than they take. The combination is deeply steady and occasionally too serious.",
  ...
  '3_7': { // Jupiter neutral Ketu, Ketu neutral Jupiter — both neutral
    rel: 'n_n',
    core: "Jupiter and Ketu — the two most philosophically and spiritually inclined energies in neutral alignment. Together they go deeper than either goes alone. The challenge is that 7's instability tests 3's need for consistency.",
  ...
  '8_8': {
    rel: 'n_n',
    core: "Double Saturn — the most deeply committed combination. Maximum loyalty, maximum patience, maximum suppressed needs. Both give everything and ask for nothing. The danger is not conflict — it is the accumulation of unspoken needs that becomes distance.",
  ...
  '7_8': {
    rel: 'n_n',
    core: "Ketu and Saturn — luck and sustained effort in neutral alignment. 7's fortune can lift 8's heavy sustained effort at exactly the right moment. 8's discipline can give 7's instability a container that actually holds. When this works, it's transformative.",
...
function _getDayHeadline(d1, d2, same, lang) {
  ...
  if (same) {
    ...
    const amplified = {
      ...
      8:"Double Saturn day — maximum weight. What's built or repaired today compounds.",
  ...
  const map = {
    ...
    '2_7':"Moon meets Ketu — emotional depth and quiet detachment. Understanding arrives without words.",
    ...
    '4_7':"Rahu meets Ketu — two restless, unconventional energies active. Deep and destabilizing in equal measure.",
    '4_8':"Rahu meets Saturn — chaos meets patience. Saturn grounds what restlessness generates today.",
...
function _getDayDetail(d1, d2, same, dr1, dr2, lang) {
  ...
  if (same) {
    ...
    const details = {
      ...
      8:"Double Saturn — maximum weight. Whatever effort is made today compounds. Whatever is repaired today holds. Don't waste it on things that don't matter.",
  ...
  const map = {
    ...
    '1_6':"Sun and warmth together. Whatever this pairing presents publicly today lands with unusual force. The audience reads you as a unit worth noticing.",
    ...
    '3_4':"Jupiter stress-tests unconventional thinking. The friction between you today is productive — 4's instinct to question 3's framework occasionally reveals something important.",
