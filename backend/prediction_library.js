...
export const COMBINATION_MEANINGS = {
  ...
  '1_3': "Leadership backed by wisdom — a rare combination. You make bold moves but think them through. Respect comes naturally. Likely to mentor others or hold institutional authority.",
...
export const DAILY_QUOTES = {
  1: [
    "A day to take the lead — your instincts are sharper than anyone else's right now.",
    "Today rewards the bold. The decision you've been postponing is ready to be made.",
    "Your presence commands attention today — use it with intention, not ego.",
    "The universe is backing your ambitions today. Step forward without hesitation.",
    "Authority is earned one decisive move at a time — today is your turn.",
  ],
  2: [
    "Today asks you to feel before you act — your emotional intelligence is your superpower.",
    "Connections made today are deeper than they appear. Pay attention to who shows up.",
    "Your sensitivity isn't weakness today — it's the sharpest tool you have.",
  ...
  3: [
    ...
    "Today is for counsel, not conflict. Your words carry unusual weight — choose them carefully.",
    "Family matters surface today. Address them with patience, not solutions.",
    "A day to teach, guide, or be guided. The lesson you receive today is the one you needed.",
    "Your judgment is sound today — trust it, especially when others doubt you.",
  ],
  4: [
    "Expect the unexpected today — and don't fight it. The disruption is the direction.",
    "Today favors research over action. Understand before you commit.",
    "Your mind moves faster than usual today — brilliant ideas arrive. Write them down immediately.",
  ...
  5: [
    ...
    "Your communication is razor-sharp today. Negotiate, propose, and close.",
    "Today is for business — every conversation is a potential transaction.",
    "Clarity about your finances arrives today if you actually look at the numbers.",
    "Your intellect is at peak today. Use it for something that matters.",
  ],
  6: [
    "Beauty, connection, and ease — today asks you to receive, not just give.",
    "Love languages are loud today — speak yours and listen for others'.",
    "Your environment affects your energy today more than usual. Surround yourself with beauty.",
    "Today is for pleasure without guilt — you've earned a moment of luxury.",
    "Relationships you've neglected call for attention today. A small gesture goes a long way.",
  ],
  7: [
    "Luck is quiet today — it's working behind the scenes whether you see it or not.",
    "Today rewards the curious. Ask the question you've been afraid to ask.",
    ...
    "The answer you're searching for is closer than you think. Stillness reveals it.",
  ],
  8: [
    "Today demands discipline — the shortcut you're considering will cost more than the long way.",
    "Hard work today doesn't just move the needle — it resets the trajectory.",
    "The karmic account is being settled today. Give your best regardless of what's given to you.",
    "Today's effort is an investment in a version of yourself that hasn't arrived yet.",
    "Resilience is the skill being tested today. You have more of it than you remember.",
  ],
  9: [
    "Energy is high today — channel it or it channels you.",
    "Today rewards courage. The bold move you've been avoiding is today's priority.",
    "Your fighting spirit is activated today — use it for progress, not conflict.",
    "Act first, analyze later today — overthinking will slow what momentum wants to deliver.",
    "Today is for the warrior in you — bold, focused, unstoppable.",
  ],
};
...
export const DAILY_GUIDANCE = {
  1: {
    ...
    avoid: [
      "Delegating the most important tasks — today only you can do them justice",
  ...
  4: {
    do: [
      ...
      "Allow disruptions — they're redirecting you",
  ...
  7: {
    ...
    avoid: [
      ...
      "Ignoring your dreams — they carry messages today",
    ],
  },
  8: {
    do: [
    ...
    avoid: [
      ...
      "Holding grudges — they're costing you more than the person who hurt you",
...
export const PERIOD_PREDICTIONS = {
  weekly: {
    1: "This week brings leadership moments — situations where your voice, decision, or presence is the turning point. Don't shrink from them. Someone in a position of authority is watching.",
...
export const LIFE_PREDICTIONS = {
  ...
  '1_1': "A life built on authority and self-reliance. You are drawn to leadership positions and often hold them. The first 30 years are about establishing identity — sometimes through conflict. After 30, the authority becomes earned, not imposed. Your ego is your greatest ally and your greatest obstacle — the same fire that drives you can isolate you.",
  ...
  '1_6': "Leadership and luxury. You are drawn to the finer things and often find yourself in environments that provide them. Career success is real. Love life is complex — you give generously but demand equally. Learning to love without conditions is the deeper lesson.",
  ...
  '2_1': "Emotional intelligence in authority. You lead through understanding people, not dominating them. Career success through relationships and creative vision. A deeply romantic life. The challenge: decisiveness — the sensitivity that makes you empathetic can make choosing difficult.",
...
export const CHART_MODIFIERS = {
  ...
  has_raj_yoga: "Raj Yoga in your chart means authority positions are your natural territory. Periods when 1 and 2 are both active bring the biggest career leaps.",
