...
export const CHART_MODIFIERS = {
  ...
  has_raj_yoga_strong: "Your specific Basic-Destiny pairing puts this Raj Yoga at full strength — the effect is not diluted by anything else in the chart.",
  has_raj_yoga_weak: "Destiny 4 or 8, or 1 repeating multiple times without Destiny 1, softens this Raj Yoga — the effect is real but weaker than the strong version.",
