...
export const COMBINATION_MEANINGS = {
  ...
  '1_2': "Authority meets sensitivity — a powerful but turbulent mix. You carry both the need to lead and the need to be loved. At best, a charismatic leader with emotional intelligence. Watch: ego clashes with those close to you.",
  '1_3': "Leadership backed by wisdom — a rare combination. You make bold moves but think you through. Respect comes naturally. Likely to mentor others or hold institutional authority.",
  '1_4': "Ambition meets unpredictability — great ideas but execution suffers. You can talk your way into rooms but struggle to finish what you start. Financial impulsiveness is a real risk.",
  ...
  '1_6': "Leadership meets luxury — you want the best of everything and often get it. Charismatic and attractive. Tendency toward excess and spending beyond means.",
  ...
  '2_7': "Emotion meets intuition — highly psychic combination. Feels things before you happen. Needs quiet and solitude to recharge. Relationships intense but unstable.",
  ...
  '3_2': "Jupiter meets Moon — knowledgeable but emotionally complex. Issues with children or fertility possible. Weight management challenge. Has enemies but you're mostly harmless.",
  ...
  '3_9': "Jupiter meets Mars — expansive energy. Wisdom plus action — can build and scale. Strong opinions, not afraid to defend you. Politics, law, or institutional leadership.",
  ...
  '6_8': "Venus meets Saturn — discipline around luxury. Wants the finer things but works for you. Creative work backed by persistence.",
  ...
  '1_7_8': "High intuition, Kali Zuban — what you sense comes true. Social work, multiple income streams. Mental peace arrives after 40. Marriage delayed.",
  '2_8_4': "Vipreet Raj Yoga — life is a rollercoaster but you survive it all. Blunt speech, financial ups and downs. With 3-1-9 in chart: success comes through adversity. Avoid addiction.",
...
export const DASHA_COMBO_PREDICTIONS = {
  // Format: maha_antar
  '1_1': "Double Sun energy — exceptional visibility period. Career leaps forward. Competition is won decisively. Ego can become a problem in personal relationships — watch your temper with loved ones.",
  ...
  '1_5': "Sun meets Mercury — excellent communication period. Business deals, negotiations, contracts favor you. Public speaking, writing, or media work flourishes.",
  ...
  '2_8': "Moon meets Saturn — heaviness, emotional burden, delayed results. With 1 or 9 in grid: superiority complex emerges. Without you: self-doubt. Keep pushing.",
  ...
  '3_7': "Jupiter meets Ketu — lucky spiritual year. What you need arrives. Travel and introspection lead to breakthroughs.",
  ...
  '4_2': "Rahu meets Moon — emotionally unstable, prone to being deceived. Keep your finances guarded and your trust limited.",
  '4_3': "Rahu meets Jupiter — illusionary wisdom. You feel wise but judgment may be clouded. Big plans need independent verification.",
  ...
  '8_8': "Double Saturn — either peak achievement (double even 8) or peak struggle (odd 8). The most karmic period. What you've built either pays off or collapses based on the integrity of its foundation.",
  '8_9': "Saturn meets Mars — relentless determination. Heavy load but enormous output. Protect your health — heart and blood pressure.",
  ...
  '9_8': "Mars meets Saturn — immense determination, heavy load. Build something lasting but protect your health relentlessly.",
...
export const DAILY_GUIDANCE = {
  1: {
    do: [
      "Make that important call or pitch — your persuasion is at its peak",
      "Start new projects or initiatives — beginnings begun today carry authority",
      "Step into leadership roles that have been offered to you",
      "Negotiate salary, contracts, or deals — you hold the stronger position",
      "Make solo decisions you've been waiting for group approval on",
    ],
    avoid: [
      "Delegating the most important tasks — today only you can do you justice",
      ...
      "Impulsive anger — your words carry authority today and wounds go deeper",
      "Starting something you cannot finish — the 1 energy commits",
    ],
  },
  2: {
    do: [
      "Have the emotional conversation you've been avoiding",
      ...
      "Trust your instincts about people — your radar is accurate today",
    ],
    avoid: [
      "Making major financial decisions — emotions cloud the numbers today",
      "Isolating — you need connection today even if you think you don't",
      "Taking criticism personally — it's not about you as much as it feels like it is",
      "Forcing resolutions in conflicts — let things settle naturally",
      "Overcommitting to people — your boundaries are softer than usual",
    ],
  },
  3: {
    do: [
      "Seek or give advice — your judgment and others' guidance are both sound today",
      "Study, research, or deepen your expertise in something that matters",
      "Spend meaningful time with family — not just proximity, actual connection",
      "Make an ethical decision you've been rationalizing away",
      "Mentor someone — your wisdom translates today",
    ],
    avoid: [
      ...
      "Overcomplicating decisions — your instinct knows the answer",
  ...
  4: {
    do: [
      ...
      "Allow disruptions — you're redirecting you",
      "Write down the brilliant ideas that arrive — you won't stay without capture",
    ],
    avoid: [
      ...
      "Making promises you'll struggle to keep — your follow-through is weakest today",
    ],
  },
  5: {
    do: [
      "Negotiate, pitch, or close a business deal",
      "Review your finances and make one sharp improvement",
      "Write, speak, or present — your communication lands with precision",
    ...
    avoid: [
      ...
      "Avoiding difficult financial conversations — clarity serves you better than comfort",
  ...
  6: {
    do: [
      ...
      "Invest in beauty — your space, your appearance, your experiences",
      "Cook for someone, host, or create an experience for people you care about",
      "Work on creative projects — Venus energy amplifies artistic output",
      "Nurture your most important relationships",
    ],
    avoid: [
      "Harsh words — your tongue is sharper than usual and wounds last",
      ...
      "Self-righteous behavior — no one needs your unsolicited judgment today",
    ],
  },
  7: {
    do: [
      "Follow your intuition even when logic argues against it",
      ...
      "Ask the question you've been afraid to ask — the answer arrives",
    ],
    avoid: [
      ...
      "Ignoring your dreams — you carry messages today",
    ],
  },
  8: {
    do: [
      "Work — genuinely, deeply, without distraction",
      "Address a long-standing karmic situation you've been avoiding",
      "Reach out to someone you've wronged or who has wronged you — resolution is available",
      "Invest in your long-term goals, even one small step",
      "Practice discipline in one area you've been undisciplined",
    ],
    avoid: [
      "Self-pity — Saturn has no patience for it and it compounds the heaviness",
      "Holding grudges — you're costing you more than the person who hurt you",
      "Taking on more than you can carry — Saturn tests limits today",
      "Shortcuts — you fail under Saturn's watch",
      "Health neglect — today's stress lands in the body",
    ],
  },
  9: {
    do: [
      "Take action on the project you've been thinking about too long",
      "Physical activity — the body needs this energy released",
      "Stand up for yourself or someone else who needs it",
      "Compete — sports, business, debate — you're operating at peak today",
    ...
    avoid: [
      ...
      "Starting more than you can finish — focus beats volume today",
    ],
  },
};
...
export const COMBO_DAILY_INSIGHTS = {
  // Raj Yoga active
  raj_yoga: {
    favorable: "Your natural authority is amplified today — decision-makers around you are unusually receptive. Push for what you want.",
  ...
  bandhan: {
    active: "You may feel unusually constrained today — deadlines, obligations, or circumstances boxing you in. This is the energy. Don't force exits; navigate carefully.",
    advice: "Legal matters, health checks, and financial obligations need attention. Don't ignore you hoping you'll resolve.",
  },
  ...
  // Vipreet Raj (2-8-4)
  vipreet_raj: {
    active: "Life is giving you the harder path today — but the harder path is the one that transforms you. Stay steady.",
    advice: "Avoid substances or escapes today. The discomfort is temporary; the growth from walking through it is permanent.",
  },
  // 3-1-9 uplifting
  uplifting_319: {
    active: "The full force of ambition, wisdom, and energy is behind you today. This is a day to move mountains.",
  },
  // 6-7-5 stable luxury
  stable_luxury: {
    active: "Even on difficult days, your standard of living holds. Today reinforces your ability to maintain what you've built.",
  },
  // 1-7 Raj Yoga
  sun_ketu_raj: {
    active: "Fortune is walking beside you today. Things you pursue have an unusual tendency to work out. Make your move.",
  },
  // 1-8 without 7 (defamation risk)
  defamation_risk: {
    active: "Be careful about what you say publicly or to authority figures today. Words can be taken out of context.",
    advice: "Document important conversations. Protect your reputation proactively.",
  },
  ...
  // Spiritual 3-7-9
  spiritual: {
    active: "Something beyond the material is trying to reach you today. Pay attention to what arrives — synchronicities are messages.",
  },
};
...
export const PERIOD_PREDICTIONS = {
  weekly: {
    1: "This week brings leadership moments — situations where your voice, decision, or presence is the turning point. Don't shrink from you. Someone in a position of authority is watching.",
    ...
    3: "A week for learning and guidance. Seek expertise you've been putting off. Family conversations that have been avoided need to happen — the energy supports resolution this week.",
    4: "An unpredictable week — plans change, surprises arrive. Don't fight the disruptions. The most productive thing you can do is stay flexible and research before committing to anything new.",
    5: "A sharp business week. Financial conversations, deals, and opportunities cluster. Your communication is at its most persuasive — use it on what matters most.",
    6: "A socially rich week — relationships, events, and aesthetic experiences converge. Good week for love, creativity, and enjoying what you've built. Watch spending.",
    7: "A fortunate week with a spiritual undertone. Things you've been waiting on begin to move. Intuition is sharper than logic — let it lead. Travel or a change of scene would be unusually productive.",
    8: "A work week in the truest sense — no shortcuts, no luck substitutes, just output. The effort you put in this week has an outsized long-term impact. Health must be protected.",
    9: "A high-energy week built for action. Start what you've been delaying. Compete where you've been hesitating. The warrior energy is with you — channel it or it becomes restlessness.",
  },
  monthly: {
    1: "This month, authority and recognition are the themes. Career moves made now carry momentum for the rest of the year. Leadership is thrust upon you — accept it. Financial gains through status.",
    2: "A deeply relational month — who you're surrounded by shapes everything. New connections carry unusual potential. Creative work peaks. Financial decisions are emotionally charged — proceed carefully.",
    3: "A month of wisdom and family. Education, mentorship, and ethical choices define the next 30 days. Something you learn this month changes how you operate for the next several years.",
    ...
    5: "A financially active month. Cash flow improves, new revenue streams emerge, business opportunities cluster. Communication is your most powerful tool — every conversation is a potential deal.",
    6: "A month of beauty, love, and social richness. Relationships deepen, creative projects flourish, your social standing rises. Watch for overspending and emotional confrontations — both are tempting this month.",
    7: "A lucky month with a spiritual dimension. Things begin resolving yourself. Travel or a significant change of environment brings breakthroughs. Intuition-led decisions outperform logic-led ones this month.",
    8: "A month that demands everything you've got. No shortcuts, no luck substitutes — pure discipline and output. The karmic accounting is running. What you put in this month builds something that lasts years.",
    9: "A month of bold moves and high energy. Launch what you've been preparing. Compete. Fight for what matters. The universe backs courage this month — timidity pays nothing.",
  },
  yearly: {
    ...
    2: "A year of depth — relationships, creativity, and emotional intelligence define your growth. New connections with influential people reshape your social world. Less about money and more about meaning.",
    3: "A year of wisdom and expansion. Education, mentorship, and family legacy are the themes. Financial growth through expertise. A year where what you know becomes what you earn.",
    4: "An unpredictable year demanding adaptability. Major life changes arrive without much warning. Financial discipline is critical — losses happen through impulsiveness. Research and technology are your allies.",
    ...
    7: "A lucky year — one where effort is rewarded beyond its usual proportion. Travel, spiritual growth, and unexpected opportunities define the year. What you've been waiting for begins arriving.",
    8: "A year of karma coming due — debts repaid, efforts rewarded, old mistakes surfacing. Relentless discipline builds something that outlasts you. Emotionally testing but profoundly transformative.",
    9: "A year of action and achievement. Bold moves pay off, competition is won, energy levels are at your highest. The warrior energy demands output — a quiet year is a wasted one.",
  },
};
...
export const LIFE_PREDICTIONS = {
  ...
  '1_1': "A life built on authority and self-reliance. You are drawn to leadership positions and often hold you. The first 30 years are about establishing identity — sometimes through conflict. After 30, the authority becomes earned, not imposed. Your ego is your greatest ally and your greatest obstacle — the same fire that drives you can isolate you.",
  '1_2': "A paradox — the leader who needs connection. You project strength but require deep emotional bonds to function at your best. Career success is real and often early. Relationships are where the real growth happens. Learning to lead with vulnerability rather than authority is the work of a lifetime.",
  '1_3': "The wise leader. You don't just achieve — you build institutions, mentor others, and leave something lasting. Education and expertise are non-negotiable for you. Father figures or mentors play decisive roles. A life of genuine respect and meaningful authority.",
  ...
  '1_5': "The powerful communicator. A life built on the intersection of authority and intelligence. Business, media, or politics suits you well. Money comes through bold communication and strategic thinking. The challenge: warmth — don't let the sharp mind crowd out the human connection.",
  '1_6': "Leadership and luxury. You are drawn to the finer things and often find yourself in environments that provide you. Career success is real. Love life is complex — you give generously but demand equally. Learning to love without conditions is the deeper lesson.",
  '1_7': "The continuously lucky leader. Life has a quality of fortune — things work out, doors open. Government, authority, and public life suit you. Love is rich and eventful. The spiritual dimension of life calls louder as you age.",
  ...
  '2_1': "Emotional intelligence in authority. You lead through understanding people, not dominating you. Career success through relationships and creative vision. A deeply romantic life. The challenge: decisiveness — the sensitivity that makes you empathetic can make choosing difficult.",
  '2_2': "Deeply emotional, deeply creative. A life of intense connection and artistic output. The world sees your warmth and your work. The private self is more fragile than the public face. Building emotional resilience is the lifelong practice.",
  '2_3': "The nurturing wise one. Family and knowledge are everything. A life of counseling, teaching, and caring. Respected deeply by those who know you. The challenge: putting your own needs last for so long that resentment builds quietly.",
  ...
  '3_3': "Double Jupiter — profound wisdom but moral flexibility risk with multiple 3s. Life path through education, spirituality, or guidance. Followed and respected. The shadow: becoming the person who preaches what you don't practice.",
  ...
  '3_9': "Bold wisdom. The academic who fights for what you believe, the lawyer who never backs down, the leader who actually knows your subject. A life of expansion, influence, and strong opinions.",
  ...
  '7_7': "Double Ketu — maximally unstable, maximally intuitive. Life is a constant change. Anxiety is managed or it manages you. The spiritual practice is not optional — it's survival.",
  ...
  '9_3': "Bold wisdom. A life of fighting for what you believe, building what you envision, and teaching what you've learned. Politics, law, or education are natural homes.",
...
export const CHART_MODIFIERS = {
  has_319: "The 3-1-9 triad in your chart adds an uplifting force — ambition, wisdom, and energy reinforce each other. Leadership and authority are amplified in whatever period is running.",
  has_675: "The 6-7-5 combination in your chart means your lifestyle is resilient. Even in difficult periods, your standard of living holds and your social standing remains intact.",
  has_284: "The 2-8-4 Vipreet Raj combination in your chart means adversity is your teacher and eventually your throne. The difficult periods transform rather than defeat.",
  has_178: "The 1-7-8 combination gives you unusually high intuition — what you sense about situations and people is usually right. Trust it more than you currently do.",
  has_raj_yoga: "Raj Yoga in your chart means authority positions are your natural territory. Certain running periods bring the biggest career leaps.",
  has_raj_yoga_strong: "Your specific chart pairing puts this Raj Yoga at full strength — the effect is not diluted by anything else in the chart.",
  has_raj_yoga_weak: "A specific pattern in your chart softens this Raj Yoga — the effect is real but weaker than the strong version.",
  has_easy_money: "Easy Money in your chart means financial luck runs through your life. The money comes, sometimes from unexpected directions. The practice is keeping it.",
  ...
  multiple_4_odd: "Odd multiple 4s in your chart amplify Rahu energy — unpredictability, financial impulsiveness, and illusion are heightened. Daily discipline is the antidote.",
  multiple_4_even: "Even multiple 4s in your chart transform Rahu's chaos into structure. Logical thinking, good planning, and purposeful travel become your strengths.",
  multiple_7: "Multiple 7s in your chart mean instability is a recurring theme — but so is luck. The anxiety is real; so is the resilience. Spiritual practice is not optional.",
  multiple_8_even: "Even multiple 8s in your chart mean Saturn's karma is working in your favor. Opportunities, achievements, and rewards come through persistence.",
  multiple_8_odd: "Odd multiple 8s in your chart mean Saturn's karma requires more work before it pays. The effort is not wasted — it's compounding.",
  multiple_9: "Multiple 9s in your chart mean frustration is a recurring companion. Physical activity, clear goals, and honest communication are the channels that make the Mars energy productive rather than destructive.",
};
...
export const PREDICTION_LOGIC = {
  ...
  how_to_read_daily: `
    ...
    2. Destiny number (WHERE you're headed, outer world influence)  
    ...
    = "A day of sharp thinking but emotional distance — excellent for analytical work,
       challenging for personal connection. The Saturn-Ketu energy wants you working
